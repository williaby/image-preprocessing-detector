...
**Access**: https://arxiv.org/abs/2509.17012 (Paper with dataset details)
...
**Access**: https://github.com/rjchern/DIQA_CNN (See dataset section in repository)
...
**Access**: https://github.com/DS4SD/DocLayNet
...
**GitHub**: https://github.com/doc-analysis/TableBank
...
**Access**: https://github.com/ibm-aur-nlp/PubTabNet
**Download**: https://dax-cdn.cdn.appdomain.cloud/dax-pubtabnet/2.0.0/pubtabnet.tar.gz
...
**Access**: https://www.icst.pku.edu.cn/cpdp/sjzy/ (Peking University)
**Alternative**: Contact dataset authors for access
...
**Access**: https://github.com/MaliParag/TFD-ICDAR2019
**Dataset**: Available through GitHub repository with PDF links
...
**Access**: https://arxiv.org/abs/2307.07887 (Paper with dataset information)
**GitHub**: https://github.com/Naagar/Handwritten_Printed_Segmentation (Related implementation)
...
**Access**: https://arxiv.org/abs/1912.02504 (Paper with dataset description)
**Note**: Dataset may require contacting authors for access
...
**Direct Download**: Available through Kaggle platform (requires account)
...
**Access**: https://github.com/DocCreator/DocCreator
**Website**: https://doc-creator.labri.fr/
**Download**: Available as compiled binaries for Linux, macOS, Windows
...
**Access**: https://github.com/microsoft/genalog
...
4. **Base Clean Documents** (User to handle locally):
   - **RVL-CDIP** (400k images):
     - Access: https://adamharley.com/rvl-cdip/
     - Hugging Face: https://huggingface.co/datasets/rvl_cdip
     - 16 document categories for diverse clean base documents
   - **Tobacco800** (800 images):
     - Access: https://www.kaggle.com/datasets/patrickaudriaz/tobacco800
     - Original: http://www.tobacco800.com/ (legacy)
   ...
   - **DocBank** (500k pages):
     ...
     - Born-digital PDFs with high quality
