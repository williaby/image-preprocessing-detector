#!/usr/bin/env python3
"""Integrate all enrichment sources into nist-sd6 Layer 2 metadata.

TEMPLATE VERSION: 1.1.0

nist-sd6 specifics:
  - 5,595 scanned tax form images (IRS structured forms, Series 2).
...
Usage:
    PYTHONPATH=/home/byron/dev/image_detection:$PYTHONPATH \
        uv run python3 scripts/integrate_nist_sd6_enrichments.py --dry-run
"""
...
__l4_parser__        = 'src/image_preprocessing_detector/annotation/parsers/handwriting/nist_sd6.py'
...
METADATA_PATH = REGISTRY_DIR / "json" / "nist_sd6_metadata.json"
LANGUAGE_ENRICHMENT_PATH = REGISTRY_DIR / "json" / "nist-sd6_language_enrichment.json"
DOCLING_LAYOUT_PATH = REGISTRY_DIR / "extracted" / "nist-sd6" / "layout_batch_0.json"
