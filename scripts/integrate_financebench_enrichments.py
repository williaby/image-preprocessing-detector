#!/usr/bin/env python3
"""Integrate all enrichment sources into financebench Layer 2 metadata.

TEMPLATE VERSION: 1.1.0

financebench specifics:
  - 54,120 born-digital financial filing pages (10-K, 10-Q) from SEC EDGAR.
  - FIN domain, 100% English, born_digital capture
...
__l4_parser__        = 'src/image_preprocessing_detector/annotation/parsers/document/financebench.py'
...
METADATA_PATH = REGISTRY_DIR / "json" / "financebench_metadata.json"
LLM_ENRICHMENT_PATH = REGISTRY_DIR / "json" / "financebench_llm_enrichment.json"
LANGUAGE_ENRICHMENT_PATH = (
    REGISTRY_DIR / "json" / "financebench_language_enrichment.json"
)
