...
echo "This will take time for large datasets (27GB + 16GB + 11GB + smaller)"
echo ""
...
add_to_dvc() {
    ...
    poetry run dvc add "data/benchmarks/${dataset}"
...
echo "2. Push to DVC cache:  poetry run dvc push"
