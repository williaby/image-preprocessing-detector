...
LANGUAGE_ENRICHMENT_PATH = REGISTRY_DIR / "json" / "invoices_kg_language_enrichment.json"
DOCLING_LAYOUT_PATH = REGISTRY_DIR / "extracted" / "invoices-kaggle" / "layout_batch_0.json"
...
def main() -> int:
    ...
    stats = run_integration(metadata, llm_index, lang_index, layout_index, dry_run=args.dry_run)
