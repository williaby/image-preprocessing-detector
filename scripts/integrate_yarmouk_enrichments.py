...
__l4_parser__        = 'src/image_preprocessing_detector/annotation/parsers/multilingual/yarmouk.py'
...
LANGUAGE_ENRICHMENT_PATH = (
    REGISTRY_DIR / "json" / "yarmouk_ocr_language_enrichment.json"
)
...
def main() -> int:
    ...
    log.info(
        "Done in %.2fs. %d integrated, %d layout, %d OCR, %d text",
        time.monotonic() - t0,
        stats["integrated"],
