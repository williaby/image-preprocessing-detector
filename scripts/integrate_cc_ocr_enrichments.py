...
def integrate_sample(s: dict[str, Any],
                     la: dict[str, list[dict[str, Any]]],
                     oc: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    data["text_direction"] = SCRIPT_TO_TEXT_DIRECTION.get(data["iso15924_script"], "ltr")
...
def run_integration(md: dict[str, Any], la: dict[str, list[dict[str, Any]]],
                    oc: dict[str, dict[str, Any]], dry_run: bool = False) -> dict[str, Any]:
    """Run integration."""
    stats: dict[str, Any] = {"total": 0, "integrated": 0, "layout_matched": 0, "ocr_matched": 0,
                              "has_text_content_count": 0, "lang_dist": Counter(), "script_family_dist": Counter()}
