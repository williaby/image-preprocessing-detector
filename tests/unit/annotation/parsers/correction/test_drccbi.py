"""Tests for DRCCBI parser."""

from __future__ import annotations

from pathlib import Path

from image_preprocessing_detector.annotation.parsers.correction.drccbi import (
    DrccbiParser,
)


class TestDrccbiParser:
    """Tests for DrccbiParser."""

    def test_dataset_names(self) -> None:
        """Parser reports correct dataset names."""
        parser = DrccbiParser()
        assert "drccbi" in parser.dataset_names
    ...
    def test_parse_sets_source(self, tmp_path: Path) -> None:
        ...
        assert labels.raw_labels.get("source") == "drccbi"
