...
import image_preprocessing_detector.utils.log_config as _log_module
...
class TestSetupLogging:
    ...
    @patch.object(_log_module.logging, "basicConfig")
    @patch.object(_log_module.structlog, "configure")
