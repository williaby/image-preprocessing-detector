...
# Minimal valid headers padded out to satisfy the min_bytes check.
PDF_BYTES = b"%PDF-1.4\n%\xe2\xe3\xcf\xd3\n"
PNG_BYTES = b"\x89PNG\r\n\x1a\nIHDR\x00\x00"
JPEG_BYTES = b"\xff\xd8\xff\xe0\x00\x10JFIF\x00\x01\x01\x00"
JPEG_EXIF_BYTES = b"\xff\xd8\xff\xe1\x00\x10Exif\x00\x00MM\x00*\x00"
TIFF_LE_BYTES = b"II*\x00\x08\x00\x00\x00\x00\x00\x00\x00"
TIFF_BE_BYTES = b"MM\x00*\x00\x00\x00\x08\x00\x00\x00\x00"
WEBP_BYTES = b"RIFF\x00\x00\x00\x00WEBPVP8 "
BMP_BYTES = b"BM\x00\x00\x00\x00\x00\x00\x00\x00\x36\x00"
