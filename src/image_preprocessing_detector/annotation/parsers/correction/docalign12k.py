...
__l4_l2_file__ = "docalign12k_metadata.json"
__l4_integrate__ = "scripts/integrate_docalign12k_enrichments.py"
...
class Docalign12KParser(BaseParser):
    ...
    def parse(
        ...
        Args:
            dataset_path (Path): Root path of the DocAlign12K dataset
            image_path (Path): Absolute path to the image file being processed
            config (dict[str, Any]): Dataset configuration dictionary (unused)

        Returns:
            OriginalLabels: OriginalLabels with alignment metadata in raw_labels
        """
