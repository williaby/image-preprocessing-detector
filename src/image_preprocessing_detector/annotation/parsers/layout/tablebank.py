...
__l4_task__ = "layout"
__l4_l2_file__ = "tablebank_metadata.json"
__l4_integrate__ = "scripts/integrate_tablebank_enrichments.py"
...
class TableBankParser(BaseParser):
    ...
    def parse(
        ...
        Args:
            dataset_path (Path): Root path of the TableBank dataset
            image_path (Path): Absolute path to the image file being processed
            config (dict[str, Any]): Dataset configuration dictionary (unused)

        Returns:
            OriginalLabels: OriginalLabels with raw_labels["tablebank_annotations"] populated
