...
__l4_l2_file__ = "tobacco800_metadata.json"
__l4_integrate__ = "scripts/integrate_tobacco800_enrichments.py"
...
class Tobacco800Parser(BaseParser):
    ...
    def parse(
        ...
        Args:
            dataset_path (Path): Root path of the Tobacco800 dataset.
