...
authors:
  - name: "Byron Williams"
purpose: "Document the decision to delegate semantic document feature extraction (table structure, reading order, footnote linking) to OCR/processing stages rather than preprocessing."
---
